...
?>
	...
	<a href="#collapse<?php echo $i; ?>" class="accordion-toggle <?php if($i==0) echo 'selected'; ?>" data-toggle="collapse" data-parent="#accordion<?php echo $module->id; ?>">
		<?php echo $item->title;?>
	</a>
	</div>

	<div id="collapse<?php echo $i; ?>" class="accordion-body collapse <?php if($i==0) echo 'in'; ?>">
